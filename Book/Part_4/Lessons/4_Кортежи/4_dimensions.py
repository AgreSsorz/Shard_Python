...
Кортеж выглядит как список, за исключением одного момента, 
у изменяемого списка скобки квадратные, а у неизменяемого, скобки круглые.
...
### Замена кортежа ###
"""
Элементы кортежа неизменяемы, но можно присвоить новое имя переменной,
в которой хранится кортеж.
"""
dimensions = (200, 50)
